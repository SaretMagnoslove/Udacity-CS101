# Quiz 2: Write Python code that prints out the number of hours in 7 weeks.

hours_seven_week = 7*7*24
print(hours_seven_week)

# Quiz 4: Write Python code that stores the distance 
...
# Quiz 6: Given the variables s and t defined as:
...
# Quiz 8: Assume text is a variable that
# holds a string. Write Python code
# that prints out the position
